...
public final class Constants {
  ...
  public static final class ArmSetpoints{
    ...
    public static final Setpoint TOP_NODE = new Setpoint(221, 156, false, ClawState.IN, 198, 118, false, ClawState.OUT, ArmState.TOP_NODE);
    public static final Setpoint TOP_NODE_PLACED = new Setpoint(221, 135, false, ClawState.IN, 211, 118, false, ClawState.OUT, ArmState.TOP_NODE_PLACED);
    public static final Setpoint TOP_NODE_PLACED_AND_OPEN = new Setpoint(221, 135, false, ClawState.OUT, 213, 115, false, ClawState.OUT, ArmState.TOP_NODE_PLACED);
