...
public class TwoHalfWithBalance extends SequentialCommandGroup {
  /** Creates a  ThreePieceAuto. */
  public TwoHalfWithBalance(DriveSubsystem drive, ArmSubsystem arm, ClawSubsytem claw) {
    ...
    PathPlannerTrajectory path7 = PathPlanner.loadPath("TwoHalfBalancePart7", new PathConstraints(4.0, 4.0));
