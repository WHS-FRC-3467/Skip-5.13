...
public class TwoPiece extends SequentialCommandGroup {
  ...
  public TwoPiece(DriveSubsystem drive, ArmSubsystem arm, ClawSubsytem claw) {
    ...
    eventMap.put("Floor position", new ParallelCommandGroup(
                                    ...
                                    Commands.run(()->claw.driveClaw(1.0)),
                                    Commands.print("Floor Position")));
                                              
    eventMap.put("Retract floor", new ParallelCommandGroup(
                              Commands.print("Retract Floor"),
                              new RetractToStowed(arm),
                              Commands.run(()-> claw.driveClaw(0.25))));

    eventMap.put("go to scoring position", new ParallelCommandGroup(
                                            Commands.print("Go to scoring position"),
