...
public class TwoPieceWithChargeRed extends SequentialCommandGroup {
  /** Creates a new TwoPieceWithCharge. */
  public TwoPieceWithChargeRed(DriveSubsystem drive, ArmSubsystem arm, ClawSubsytem claw) {
    PathPlannerTrajectory path1 = PathPlanner.loadPath("TwoPiecePart1Red", new PathConstraints(2.5, 4.0));
    PathPlannerTrajectory path2 = PathPlanner.loadPath("TwoPiecePart2Red", new PathConstraints(3.5, 6.0));
    PathPlannerTrajectory path3 = PathPlanner.loadPath("TwoPiecePart3Red", new PathConstraints(3.5, 6.0));
    PathPlannerTrajectory path4 = PathPlanner.loadPath("TwoPiecePart4Red", new PathConstraints(2.0, 2.0));
    PathPlannerTrajectory path5 = PathPlanner.loadPath("TwoPiecewithChargePart5Red", new PathConstraints(4.0, 6.0));
