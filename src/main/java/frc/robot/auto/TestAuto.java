...
public class TestAuto extends SequentialCommandGroup {
  ...
  public TestAuto(DriveSubsystem drive, ArmSubsystem arm, ClawSubsytem claw) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    PathPlannerTrajectory path1 = PathPlanner.loadPath("TwoPiecePart1", new PathConstraints(3.5, 4.0));
    PathPlannerTrajectory path3 = PathPlanner.loadPath("TwoPiecePart3", new PathConstraints(3.5, 4.0));
    addCommands(
