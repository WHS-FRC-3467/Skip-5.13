...
public class OneConeClose extends SequentialCommandGroup {
  /** Creates a new OneConeAuto. */
  public OneConeClose(DriveSubsystem drive, ArmSubsystem arm, ClawSubsytem claw) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    PathPlannerTrajectory path1 = PathPlanner.loadPath("OneConeClose", 1.0, 1.0);
    addCommands(
